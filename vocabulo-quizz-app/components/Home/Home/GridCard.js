...
const GridCardHome = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('http://192.168.1.15:3000/api/categories');
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.recapContainer}>
                ...
                <Text style={styles.recapCount}>{selectedCategory.totalWordCount} mots</Text>
              </View>
              ...
              <ScrollView style={{ maxHeight: 300 }}>
                ...
                {selectedCategory.categoryWords && (
                  <CategoryModal words={applyFilter(selectedCategory.categoryWords)} />
                )}
                ...
                {(selectedCategory.subcategories || []).map((subcategory) => (
                  <SubcategoryModal
                    ...
                    subcategory={{
                      ...subcategory,
                      words: applyFilter(subcategory.words || []),
                    }}
                  />
                ))}
              </ScrollView>
