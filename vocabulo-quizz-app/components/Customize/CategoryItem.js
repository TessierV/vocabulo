...
const CategoryItem = ({ category, darkMode }) => {
    ...
    // Couleurs en fonction du mode sombre
    ...
    // SVG pour chaque niveau de difficulté
    ...
    // Choisir l'icône SVG en fonction de la difficulté
    const difficultyIconXml = difficultySVGs[category.difficulty] || '';
